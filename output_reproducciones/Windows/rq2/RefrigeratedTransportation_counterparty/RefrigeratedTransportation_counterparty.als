...
pred blue_transition__S02__a__S02__mediante_met_transferResponsibility {
	some x: EstadoConcreto | partitionS02[x] and (not pre_transferResponsibility[x] or (all newCounterparty:{this/Address} | pre_params_transferResponsibility[x,x._counterparty, newCounterparty] implies some y:EstadoConcreto | met_transferResponsibility[x,y,x._counterparty, newCounterparty] and not partitionS02[y]))
}
...
pred blue_transition__S01__a__S02__mediante_met_transferResponsibility {
	some x: EstadoConcreto | partitionS01[x] and (not pre_transferResponsibility[x] or (all newCounterparty:{this/Address} | pre_params_transferResponsibility[x,x._counterparty, newCounterparty] implies some y:EstadoConcreto | met_transferResponsibility[x,y,x._counterparty, newCounterparty] and not partitionS02[y]))
}
...
pred blue_transition__S02__a__S03__mediante_met_complete {
	some x: EstadoConcreto | partitionS02[x] and (not pre_complete[x] or (pre_params_complete[x,x._counterparty] implies some y:EstadoConcreto | met_complete[x,y,x._counterparty] and not partitionS03[y]))
}
...
pred blue_transition__S00__a__S01__mediante_met_constructor {
	some x: EstadoConcreto | partitionS00[x] and ((all device:{this/Address}, supplyChainOwner:{this/Address}, supplyChainObserver:{this/Address}, minHumidity:{Int}, maxHumidity:{Int}, minTemperature:{Int}, maxTemperature:{Int} | pre_params_constructor[x,x._counterparty, device, supplyChainOwner, supplyChainObserver, minHumidity, maxHumidity, minTemperature, maxTemperature] implies some y:EstadoConcreto | met_constructor[x,y,x._counterparty, device, supplyChainOwner, supplyChainObserver, minHumidity, maxHumidity, minTemperature, maxTemperature] and not partitionS01[y]))
}
