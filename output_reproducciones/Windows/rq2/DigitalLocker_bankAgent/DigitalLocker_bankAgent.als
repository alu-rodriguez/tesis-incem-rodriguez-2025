...
pred blue_transition__S03__a__S06__mediante_met_terminate {
	some x: EstadoConcreto | partitionS03[x] and (not pre_terminate[x] or (pre_params_terminate[x,x._bankAgent] implies some y:EstadoConcreto | met_terminate[x,y,x._bankAgent] and not partitionS06[y]))
}
...
pred blue_transition__S04__a__S03__mediante_met_rejectSharingRequest {
	some x: EstadoConcreto | partitionS04[x] and (not pre_rejectSharingRequest[x] or (pre_params_rejectSharingRequest[x,x._bankAgent] implies some y:EstadoConcreto | met_rejectSharingRequest[x,y,x._bankAgent] and not partitionS03[y]))
}
...
pred blue_transition__S03__a__S05__mediante_met_shareWithThirdParty {
	some x: EstadoConcreto | partitionS03[x] and (not pre_shareWithThirdParty[x] or (all thirdPartyRequestor:{this/Address}, expirationDate:{this/Texto}, intendedPurpose:{this/Texto} | pre_params_shareWithThirdParty[x,x._bankAgent, thirdPartyRequestor, expirationDate, intendedPurpose] implies some y:EstadoConcreto | met_shareWithThirdParty[x,y,x._bankAgent, thirdPartyRequestor, expirationDate, intendedPurpose] and not partitionS05[y]))
}
...
pred blue_transition__S01__a__S02__mediante_met_beginReviewProcess {
	some x: EstadoConcreto | partitionS01[x] and (not pre_beginReviewProcess[x] or (pre_params_beginReviewProcess[x,x._bankAgent] implies some y:EstadoConcreto | met_beginReviewProcess[x,y,x._bankAgent] and not partitionS02[y]))
}
...
pred blue_transition__S04__a__S06__mediante_met_terminate {
	some x: EstadoConcreto | partitionS04[x] and (not pre_terminate[x] or (pre_params_terminate[x,x._bankAgent] implies some y:EstadoConcreto | met_terminate[x,y,x._bankAgent] and not partitionS06[y]))
}
...
pred blue_transition__S05__a__S03__mediante_met_revokeAccessFromThirdParty {
	some x: EstadoConcreto | partitionS05[x] and (not pre_revokeAccessFromThirdParty[x] or (pre_params_revokeAccessFromThirdParty[x,x._bankAgent] implies some y:EstadoConcreto | met_revokeAccessFromThirdParty[x,y,x._bankAgent] and not partitionS03[y]))
}
...
pred blue_transition__S05__a__S03__mediante_met_releaseLockerAccess {
	some x: EstadoConcreto | partitionS05[x] and (not pre_releaseLockerAccess[x] or (pre_params_releaseLockerAccess[x,x._bankAgent] implies some y:EstadoConcreto | met_releaseLockerAccess[x,y,x._bankAgent] and not partitionS03[y]))
}
...
pred blue_transition__S02__a__S03__mediante_met_uploadDocuments {
	some x: EstadoConcreto | partitionS02[x] and (not pre_uploadDocuments[x] or (all lockerIdentifier:{this/Texto}, image:{this/Texto} | pre_params_uploadDocuments[x,x._bankAgent, lockerIdentifier, image] implies some y:EstadoConcreto | met_uploadDocuments[x,y,x._bankAgent, lockerIdentifier, image] and not partitionS03[y]))
}
...
pred blue_transition__S00__a__S01__mediante_met_constructor {
	some x: EstadoConcreto | partitionS00[x] and ((all bankAgent:{this/Address}, lockerFriendlyName:{this/Texto} | pre_params_constructor[x,x._bankAgent, bankAgent, lockerFriendlyName] implies some y:EstadoConcreto | met_constructor[x,y,x._bankAgent, bankAgent, lockerFriendlyName] and not partitionS01[y]))
}
...
pred blue_transition__S03__a__S04__mediante_met_requestLockerAccess {
	some x: EstadoConcreto | partitionS03[x] and (not pre_requestLockerAccess[x] or (all intendedPurpose:{this/Texto} | pre_params_requestLockerAccess[x,x._bankAgent, intendedPurpose] implies some y:EstadoConcreto | met_requestLockerAccess[x,y,x._bankAgent, intendedPurpose] and not partitionS04[y]))
}
...
pred blue_transition__S04__a__S05__mediante_met_acceptSharingRequest {
	some x: EstadoConcreto | partitionS04[x] and (not pre_acceptSharingRequest[x] or (pre_params_acceptSharingRequest[x,x._bankAgent] implies some y:EstadoConcreto | met_acceptSharingRequest[x,y,x._bankAgent] and not partitionS05[y]))
}
...
pred blue_transition__S05__a__S06__mediante_met_terminate {
	some x: EstadoConcreto | partitionS05[x] and (not pre_terminate[x] or (pre_params_terminate[x,x._bankAgent] implies some y:EstadoConcreto | met_terminate[x,y,x._bankAgent] and not partitionS06[y]))
}
