...
pred blue_transition__S02__a__S02__mediante_met_ingestTelemetry {
	some x: EstadoConcreto | partitionS02[x] and (not pre_ingestTelemetry[x] or (all sender:{this/Address}, humidity:{Int}, temperature:{Int}, timestamp:{Int} | pre_params_ingestTelemetry[x,sender, humidity, temperature, timestamp] implies some y:EstadoConcreto | met_ingestTelemetry[x,y,sender, humidity, temperature, timestamp] and not partitionS02[y]))
}
...
pred blue_transition__S00__a__S01__mediante_met_constructor {
	some x: EstadoConcreto | partitionS00[x] and ((all sender:{this/Address}, device:{this/Address}, supplyChainOwner:{this/Address}, supplyChainObserver:{this/Address}, minHumidity:{Int}, maxHumidity:{Int}, minTemperature:{Int}, maxTemperature:{Int} | pre_params_constructor[x,sender, device, supplyChainOwner, supplyChainObserver, minHumidity, maxHumidity, minTemperature, maxTemperature] implies some y:EstadoConcreto | met_constructor[x,y,sender, device, supplyChainOwner, supplyChainObserver, minHumidity, maxHumidity, minTemperature, maxTemperature] and not partitionS01[y]))
}
...
pred turquoise_transition__S01__a__S01_S04__mediante_met_ingestTelemetry {
	some x: EstadoConcreto | partitionS01[x] and (not pre_ingestTelemetry[x] or (all sender:{this/Address}, humidity:{Int}, temperature:{Int}, timestamp:{Int} | pre_params_ingestTelemetry[x,sender, humidity, temperature, timestamp] implies some y:EstadoConcreto | met_ingestTelemetry[x,y,sender, humidity, temperature, timestamp] and not partitionS01[y] and not partitionS04[y]))
}
run turquoise_transition__S01__a__S01_S04__mediante_met_ingestTelemetry for 10 EstadoConcreto

pred turquoise_transition__S02__a__S02_S04__mediante_met_ingestTelemetry {
	some x: EstadoConcreto | partitionS02[x] and (not pre_ingestTelemetry[x] or (all sender:{this/Address}, humidity:{Int}, temperature:{Int}, timestamp:{Int} | pre_params_ingestTelemetry[x,sender, humidity, temperature, timestamp] implies some y:EstadoConcreto | met_ingestTelemetry[x,y,sender, humidity, temperature, timestamp] and not partitionS02[y] and not partitionS04[y]))
}
run turquoise_transition__S02__a__S02_S04__mediante_met_ingestTelemetry for 10 EstadoConcreto
