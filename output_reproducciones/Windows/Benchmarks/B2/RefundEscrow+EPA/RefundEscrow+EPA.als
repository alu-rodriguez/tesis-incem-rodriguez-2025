...
pred blue_transition__S100__a__S100__mediante_met_t {
	some x: EstadoConcreto | partitionS100[x] and (not pre_t[x] or (all sender:{this/Address}, timeElapsed:{Int} | pre_params_t[x,sender, timeElapsed] implies some y:EstadoConcreto | met_t[x,y,sender, timeElapsed] and not partitionS100[y]))
}
run blue_transition__S100__a__S100__mediante_met_t for 10 EstadoConcreto, 5 Deposit, 10 SumatoriaSeq

pred blue_transition__S65__a__S65__mediante_met_t {
	some x: EstadoConcreto | partitionS65[x] and (not pre_t[x] or (all sender:{this/Address}, timeElapsed:{Int} | pre_params_t[x,sender, timeElapsed] implies some y:EstadoConcreto | met_t[x,y,sender, timeElapsed] and not partitionS65[y]))
}
run blue_transition__S65__a__S65__mediante_met_t for 10 EstadoConcreto, 5 Deposit, 10 SumatoriaSeq

pred blue_transition__S00__a__S24__mediante_met_constructor {
	some x: EstadoConcreto | partitionS00[x] and ((all sender:{this/Address}, beneficiary:{this/Address} | pre_params_constructor[x,sender, beneficiary] implies some y:EstadoConcreto | met_constructor[x,y,sender, beneficiary] and not partitionS24[y]))
}
run blue_transition__S00__a__S24__mediante_met_constructor for 10 EstadoConcreto, 5 Deposit, 10 SumatoriaSeq

pred blue_transition__S100__a__S100__mediante_met_transferPrimary {
	some x: EstadoConcreto | partitionS100[x] and (not pre_transferPrimary[x] or (all sender:{this/Address}, recipient:{this/Address} | pre_params_transferPrimary[x,sender, recipient] implies some y:EstadoConcreto | met_transferPrimary[x,y,sender, recipient] and not partitionS100[y]))
}
run blue_transition__S100__a__S100__mediante_met_transferPrimary for 10 EstadoConcreto, 5 Deposit, 10 SumatoriaSeq

pred blue_transition__S24__a__S65__mediante_met_enableRefunds {
	some x: EstadoConcreto | partitionS24[x] and (not pre_enableRefunds[x] or (all sender:{this/Address} | pre_params_enableRefunds[x,sender] implies some y:EstadoConcreto | met_enableRefunds[x,y,sender] and not partitionS65[y]))
}
run blue_transition__S24__a__S65__mediante_met_enableRefunds for 10 EstadoConcreto, 5 Deposit, 10 SumatoriaSeq

pred blue_transition__S24__a__S100__mediante_met_enableRefunds {
	some x: EstadoConcreto | partitionS24[x] and (not pre_enableRefunds[x] or (all sender:{this/Address} | pre_params_enableRefunds[x,sender] implies some y:EstadoConcreto | met_enableRefunds[x,y,sender] and not partitionS100[y]))
}
run blue_transition__S24__a__S100__mediante_met_enableRefunds for 10 EstadoConcreto, 5 Deposit, 10 SumatoriaSeq

pred blue_transition__S65__a__S65__mediante_met_transferPrimary {
	some x: EstadoConcreto | partitionS65[x] and (not pre_transferPrimary[x] or (all sender:{this/Address}, recipient:{this/Address} | pre_params_transferPrimary[x,sender, recipient] implies some y:EstadoConcreto | met_transferPrimary[x,y,sender, recipient] and not partitionS65[y]))
}
run blue_transition__S65__a__S65__mediante_met_transferPrimary for 10 EstadoConcreto, 5 Deposit, 10 SumatoriaSeq

pred blue_transition__S24__a__S66__mediante_met_close {
	some x: EstadoConcreto | partitionS24[x] and (not pre_close[x] or (all sender:{this/Address}, refundee:{this/Address}, value:{Int} | pre_params_close[x,sender, refundee, value] implies some y:EstadoConcreto | met_close[x,y,sender, refundee, value] and not partitionS66[y]))
}
run blue_transition__S24__a__S66__mediante_met_close for 10 EstadoConcreto, 5 Deposit, 10 SumatoriaSeq

pred blue_transition__S24__a__S100__mediante_met_close {
	some x: EstadoConcreto | partitionS24[x] and (not pre_close[x] or (all sender:{this/Address}, refundee:{this/Address}, value:{Int} | pre_params_close[x,sender, refundee, value] implies some y:EstadoConcreto | met_close[x,y,sender, refundee, value] and not partitionS100[y]))
}
run blue_transition__S24__a__S100__mediante_met_close for 10 EstadoConcreto, 5 Deposit, 10 SumatoriaSeq

pred blue_transition__S24__a__S24__mediante_met_deposit {
	some x: EstadoConcreto | partitionS24[x] and (not pre_deposit[x] or (all sender:{this/Address}, refundee:{this/Address}, value:{Int} | pre_params_deposit[x,sender, refundee, value] implies some y:EstadoConcreto | met_deposit[x,y,sender, refundee, value] and not partitionS24[y]))
}
run blue_transition__S24__a__S24__mediante_met_deposit for 10 EstadoConcreto, 5 Deposit, 10 SumatoriaSeq

pred blue_transition__S66__a__S100__mediante_met_beneficiaryWithdraw {
	some x: EstadoConcreto | partitionS66[x] and (not pre_beneficiaryWithdraw[x] or (all sender:{this/Address} | pre_params_beneficiaryWithdraw[x,sender] implies some y:EstadoConcreto | met_beneficiaryWithdraw[x,y,sender] and not partitionS100[y]))
}
run blue_transition__S66__a__S100__mediante_met_beneficiaryWithdraw for 10 EstadoConcreto, 5 Deposit, 10 SumatoriaSeq

pred blue_transition__S121__a__S121__mediante_met_t {
	some x: EstadoConcreto | partitionS121[x] and (not pre_t[x] or (all sender:{this/Address}, timeElapsed:{Int} | pre_params_t[x,sender, timeElapsed] implies some y:EstadoConcreto | met_t[x,y,sender, timeElapsed] and not partitionS121[y]))
}
run blue_transition__S121__a__S121__mediante_met_t for 10 EstadoConcreto, 5 Deposit, 10 SumatoriaSeq

pred blue_transition__S66__a__S66__mediante_met_transferPrimary {
	some x: EstadoConcreto | partitionS66[x] and (not pre_transferPrimary[x] or (all sender:{this/Address}, recipient:{this/Address} | pre_params_transferPrimary[x,sender, recipient] implies some y:EstadoConcreto | met_transferPrimary[x,y,sender, recipient] and not partitionS66[y]))
}
run blue_transition__S66__a__S66__mediante_met_transferPrimary for 10 EstadoConcreto, 5 Deposit, 10 SumatoriaSeq

pred blue_transition__S66__a__S66__mediante_met_t {
	some x: EstadoConcreto | partitionS66[x] and (not pre_t[x] or (all sender:{this/Address}, timeElapsed:{Int} | pre_params_t[x,sender, timeElapsed] implies some y:EstadoConcreto | met_t[x,y,sender, timeElapsed] and not partitionS66[y]))
}
run blue_transition__S66__a__S66__mediante_met_t for 10 EstadoConcreto, 5 Deposit, 10 SumatoriaSeq

pred blue_transition__S24__a__S24__mediante_met_transferPrimary {
	some x: EstadoConcreto | partitionS24[x] and (not pre_transferPrimary[x] or (all sender:{this/Address}, recipient:{this/Address} | pre_params_transferPrimary[x,sender, recipient] implies some y:EstadoConcreto | met_transferPrimary[x,y,sender, recipient] and not partitionS24[y]))
}
run blue_transition__S24__a__S24__mediante_met_transferPrimary for 10 EstadoConcreto, 5 Deposit, 10 SumatoriaSeq

pred blue_transition__S65__a__S65__mediante_met_withdraw {
	some x: EstadoConcreto | partitionS65[x] and (not pre_withdraw[x] or (all sender:{this/Address}, payee:{this/Address} | pre_params_withdraw[x,sender, payee] implies some y:EstadoConcreto | met_withdraw[x,y,sender, payee] and not partitionS65[y]))
}
run blue_transition__S65__a__S65__mediante_met_withdraw for 10 EstadoConcreto, 5 Deposit, 10 SumatoriaSeq

pred blue_transition__S65__a__S100__mediante_met_withdraw {
	some x: EstadoConcreto | partitionS65[x] and (not pre_withdraw[x] or (all sender:{this/Address}, payee:{this/Address} | pre_params_withdraw[x,sender, payee] implies some y:EstadoConcreto | met_withdraw[x,y,sender, payee] and not partitionS100[y]))
}
run blue_transition__S65__a__S100__mediante_met_withdraw for 10 EstadoConcreto, 5 Deposit, 10 SumatoriaSeq

pred blue_transition__S24__a__S24__mediante_met_t {
	some x: EstadoConcreto | partitionS24[x] and (not pre_t[x] or (all sender:{this/Address}, timeElapsed:{Int} | pre_params_t[x,sender, timeElapsed] implies some y:EstadoConcreto | met_t[x,y,sender, timeElapsed] and not partitionS24[y]))
}
run blue_transition__S24__a__S24__mediante_met_t for 10 EstadoConcreto, 5 Deposit, 10 SumatoriaSeq
...
pred turquoise_transition__S24__a__S66_S100__mediante_met_close {
	some x: EstadoConcreto | partitionS24[x] and (not pre_close[x] or (all sender:{this/Address}, refundee:{this/Address}, value:{Int} | pre_params_close[x,sender, refundee, value] implies some y:EstadoConcreto | met_close[x,y,sender, refundee, value] and not partitionS66[y] and not partitionS100[y]))
}
run turquoise_transition__S24__a__S66_S100__mediante_met_close for 10 EstadoConcreto, 5 Deposit, 10 SumatoriaSeq

pred turquoise_transition__S24__a__S65_S100__mediante_met_enableRefunds {
	some x: EstadoConcreto | partitionS24[x] and (not pre_enableRefunds[x] or (all sender:{this/Address} | pre_params_enableRefunds[x,sender] implies some y:EstadoConcreto | met_enableRefunds[x,y,sender] and not partitionS65[y] and not partitionS100[y]))
}
run turquoise_transition__S24__a__S65_S100__mediante_met_enableRefunds for 10 EstadoConcreto, 5 Deposit, 10 SumatoriaSeq
