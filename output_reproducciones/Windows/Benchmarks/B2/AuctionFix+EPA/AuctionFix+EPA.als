...
pred blue_transition__S00__a__S06__mediante_met_constructor {
	some x: EstadoConcreto | partitionS00[x] and ((all sender:{this/Address}, beneficiary:{this/Address}, auctionStart:{Int}, biddingTime:{Int} | pre_params_constructor[x,sender, beneficiary, auctionStart, biddingTime] implies some y:EstadoConcreto | met_constructor[x,y,sender, beneficiary, auctionStart, biddingTime] and not partitionS06[y]))
}
...
pred blue_transition__S00__a__S09__mediante_met_constructor {
	some x: EstadoConcreto | partitionS00[x] and ((all sender:{this/Address}, beneficiary:{this/Address}, auctionStart:{Int}, biddingTime:{Int} | pre_params_constructor[x,sender, beneficiary, auctionStart, biddingTime] implies some y:EstadoConcreto | met_constructor[x,y,sender, beneficiary, auctionStart, biddingTime] and not partitionS09[y]))
}
run blue_transition__S00__a__S09__mediante_met_constructor for 10 EstadoConcreto

pred blue_transition__S04__a__S02__mediante_met_t {
	some x: EstadoConcreto | partitionS04[x] and (not pre_t[x] or (all sender:{this/Address} | pre_params_t[x,sender] implies some y:EstadoConcreto | met_t[x,y,sender] and not partitionS02[y]))
}
run blue_transition__S04__a__S02__mediante_met_t for 10 EstadoConcreto
...
pred blue_transition__S09__a__S06__mediante_met_t {
	some x: EstadoConcreto | partitionS09[x] and (not pre_t[x] or (all sender:{this/Address} | pre_params_t[x,sender] implies some y:EstadoConcreto | met_t[x,y,sender] and not partitionS06[y]))
}
run blue_transition__S09__a__S06__mediante_met_t for 10 EstadoConcreto
...
pred turquoise_transition__S04__a__S02_S04__mediante_met_t {
	some x: EstadoConcreto | partitionS04[x] and (not pre_t[x] or (all sender:{this/Address} | pre_params_t[x,sender] implies some y:EstadoConcreto | met_t[x,y,sender] and not partitionS02[y] and not partitionS04[y]))
}
run turquoise_transition__S04__a__S02_S04__mediante_met_t for 10 EstadoConcreto
...
pred turquoise_transition__S09__a__S06_S09__mediante_met_t {
	some x: EstadoConcreto | partitionS09[x] and (not pre_t[x] or (all sender:{this/Address} | pre_params_t[x,sender] implies some y:EstadoConcreto | met_t[x,y,sender] and not partitionS06[y] and not partitionS09[y]))
}
run turquoise_transition__S09__a__S06_S09__mediante_met_t for 10 EstadoConcreto
