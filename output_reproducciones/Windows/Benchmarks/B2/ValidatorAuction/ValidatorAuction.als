...
pred blue_transition__S01__a__S02__mediante_met_startAuction {
	some x: EstadoConcreto | partitionS01[x] and (not pre_startAuction[x] or (all sender:{this/Address} | pre_params_startAuction[x,sender] implies some y:EstadoConcreto | met_startAuction[x,y,sender] and not partitionS02[y]))
}
run blue_transition__S01__a__S02__mediante_met_startAuction for 10 EstadoConcreto, 3 DepositLocker
...
run blue_transition__S04__a__S04__mediante_met_t for 10 EstadoConcreto, 3 DepositLocker

pred blue_transition__S01__a__S01__mediante_met_addToWhitelist {
	some x: EstadoConcreto | partitionS01[x] and (not pre_addToWhitelist[x] or (all sender:{this/Address}, addressesToWhitelist:{this/Address} | pre_params_addToWhitelist[x,sender, addressesToWhitelist] implies some y:EstadoConcreto | met_addToWhitelist[x,y,sender, addressesToWhitelist] and not partitionS01[y]))
}
run blue_transition__S01__a__S01__mediante_met_addToWhitelist for 10 EstadoConcreto, 3 DepositLocker
...
run blue_transition__S01__a__S01__mediante_met_t for 10 EstadoConcreto, 3 DepositLocker
...
run blue_transition__S02__a__S02__mediante_met_t for 10 EstadoConcreto, 3 DepositLocker

pred blue_transition__S02__a__S03__mediante_met_closeAuction {
	some x: EstadoConcreto | partitionS02[x] and (not pre_closeAuction[x] or (all sender:{this/Address} | pre_params_closeAuction[x,sender] implies some y:EstadoConcreto | met_closeAuction[x,y,sender] and not partitionS03[y]))
}
run blue_transition__S02__a__S03__mediante_met_closeAuction for 10 EstadoConcreto, 3 DepositLocker

pred blue_transition__S02__a__S05__mediante_met_closeAuction {
	some x: EstadoConcreto | partitionS02[x] and (not pre_closeAuction[x] or (all sender:{this/Address} | pre_params_closeAuction[x,sender] implies some y:EstadoConcreto | met_closeAuction[x,y,sender] and not partitionS05[y]))
}
run blue_transition__S02__a__S05__mediante_met_closeAuction for 10 EstadoConcreto, 3 DepositLocker

pred blue_transition__S03__a__S04__mediante_met_depositBids {
	some x: EstadoConcreto | partitionS03[x] and (not pre_depositBids[x] or (all sender:{this/Address}, value:{Int} | pre_params_depositBids[x,sender, value] implies some y:EstadoConcreto | met_depositBids[x,y,sender, value] and not partitionS04[y]))
}
run blue_transition__S03__a__S04__mediante_met_depositBids for 10 EstadoConcreto, 3 DepositLocker
...
run blue_transition__S05__a__S05__mediante_met_withdraw for 10 EstadoConcreto, 3 DepositLocker
...
run blue_transition__S04__a__S04__mediante_met_withdraw for 10 EstadoConcreto, 3 DepositLocker
...
run blue_transition__S03__a__S03__mediante_met_t for 10 EstadoConcreto, 3 DepositLocker
...
run blue_transition__S05__a__S05__mediante_met_t for 10 EstadoConcreto, 3 DepositLocker

pred blue_transition__S00__a__S01__mediante_met_constructor {
	some x: EstadoConcreto | partitionS00[x] and ((all sender:{this/Address}, slasher:{this/Address}, depositorsProxy:{this/Address}, startPriceInWei:{Int}, auctionDurationInDays:{Int}, minimalNumberOfParticipants:{Int}, maximalNumberOfParticipants:{Int}, releaseTimestamp:{Int}, depositLocker:{this/DepositLocker} | pre_params_constructor[x,sender, slasher, depositorsProxy, startPriceInWei, auctionDurationInDays, minimalNumberOfParticipants, maximalNumberOfParticipants, releaseTimestamp, depositLocker] implies some y:EstadoConcreto | met_constructor[x,y,sender, slasher, depositorsProxy, startPriceInWei, auctionDurationInDays, minimalNumberOfParticipants, maximalNumberOfParticipants, releaseTimestamp, depositLocker] and not partitionS01[y]))
}
run blue_transition__S00__a__S01__mediante_met_constructor for 10 EstadoConcreto, 3 DepositLocker

pred blue_transition__S02__a__S02__mediante_met_bid {
	some x: EstadoConcreto | partitionS02[x] and (not pre_bid[x] or (all sender:{this/Address}, value:{Int}, currentPrice:{Int} | pre_params_bid[x,sender, value, currentPrice] implies some y:EstadoConcreto | met_bid[x,y,sender, value, currentPrice] and not partitionS02[y]))
}
run blue_transition__S02__a__S02__mediante_met_bid for 10 EstadoConcreto, 3 DepositLocker

pred blue_transition__S02__a__S03__mediante_met_bid {
	some x: EstadoConcreto | partitionS02[x] and (not pre_bid[x] or (all sender:{this/Address}, value:{Int}, currentPrice:{Int} | pre_params_bid[x,sender, value, currentPrice] implies some y:EstadoConcreto | met_bid[x,y,sender, value, currentPrice] and not partitionS03[y]))
}
run blue_transition__S02__a__S03__mediante_met_bid for 10 EstadoConcreto, 3 DepositLocker
