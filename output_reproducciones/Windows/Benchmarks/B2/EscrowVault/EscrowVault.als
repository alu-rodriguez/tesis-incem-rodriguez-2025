...
pred blue_transition__S00__a__S01__mediante_met_constructor {
	some x: EstadoConcreto | partitionS00[x] and ((all sender:{this/Address}, superOwner:{this/Address}, beneficiary:{this/Address} | pre_params_constructor[x,sender, superOwner, beneficiary] implies some y:EstadoConcreto | met_constructor[x,y,sender, superOwner, beneficiary] and not partitionS01[y]))
}
run blue_transition__S00__a__S01__mediante_met_constructor for 10 EstadoConcreto, 5 Deposit, 10 SumatoriaSeq

pred blue_transition__S02__a__S02__mediante_met_transferOwnership {
	some x: EstadoConcreto | partitionS02[x] and (not pre_transferOwnership[x] or (all sender:{this/Address}, recipient:{this/Address} | pre_params_transferOwnership[x,sender, recipient] implies some y:EstadoConcreto | met_transferOwnership[x,y,sender, recipient] and not partitionS02[y]))
}
run blue_transition__S02__a__S02__mediante_met_transferOwnership for 10 EstadoConcreto, 5 Deposit, 10 SumatoriaSeq

pred blue_transition__S03__a__S03__mediante_met_withdrawAll {
	some x: EstadoConcreto | partitionS03[x] and (not pre_withdrawAll[x] or (all sender:{this/Address} | pre_params_withdrawAll[x,sender] implies some y:EstadoConcreto | met_withdrawAll[x,y,sender] and not partitionS03[y]))
}
run blue_transition__S03__a__S03__mediante_met_withdrawAll for 10 EstadoConcreto, 5 Deposit, 10 SumatoriaSeq

pred blue_transition__S02__a__S02__mediante_met_refund {
	some x: EstadoConcreto | partitionS02[x] and (not pre_refund[x] or (all sender:{this/Address}, investor:{this/Address} | pre_params_refund[x,sender, investor] implies some y:EstadoConcreto | met_refund[x,y,sender, investor] and not partitionS02[y]))
}
run blue_transition__S02__a__S02__mediante_met_refund for 10 EstadoConcreto, 5 Deposit, 10 SumatoriaSeq

pred blue_transition__S03__a__S04__mediante_met_close {
	some x: EstadoConcreto | partitionS03[x] and (not pre_close[x] or (all sender:{this/Address} | pre_params_close[x,sender] implies some y:EstadoConcreto | met_close[x,y,sender] and not partitionS04[y]))
}
run blue_transition__S03__a__S04__mediante_met_close for 10 EstadoConcreto, 5 Deposit, 10 SumatoriaSeq

pred blue_transition__S03__a__S03__mediante_met_transferOwnership {
	some x: EstadoConcreto | partitionS03[x] and (not pre_transferOwnership[x] or (all sender:{this/Address}, recipient:{this/Address} | pre_params_transferOwnership[x,sender, recipient] implies some y:EstadoConcreto | met_transferOwnership[x,y,sender, recipient] and not partitionS03[y]))
}
run blue_transition__S03__a__S03__mediante_met_transferOwnership for 10 EstadoConcreto, 5 Deposit, 10 SumatoriaSeq
...
run blue_transition__S01__a__S01__mediante_met_t for 10 EstadoConcreto, 5 Deposit, 10 SumatoriaSeq

pred blue_transition__S03__a__S03__mediante_met_withdraw {
	some x: EstadoConcreto | partitionS03[x] and (not pre_withdraw[x] or (all sender:{this/Address}, amount:{Int} | pre_params_withdraw[x,sender, amount] implies some y:EstadoConcreto | met_withdraw[x,y,sender, amount] and not partitionS03[y]))
}
run blue_transition__S03__a__S03__mediante_met_withdraw for 10 EstadoConcreto, 5 Deposit, 10 SumatoriaSeq
...
run blue_transition__S04__a__S04__mediante_met_t for 10 EstadoConcreto, 5 Deposit, 10 SumatoriaSeq

pred blue_transition__S04__a__S04__mediante_met_transferOwnership {
	some x: EstadoConcreto | partitionS04[x] and (not pre_transferOwnership[x] or (all sender:{this/Address}, recipient:{this/Address} | pre_params_transferOwnership[x,sender, recipient] implies some y:EstadoConcreto | met_transferOwnership[x,y,sender, recipient] and not partitionS04[y]))
}
run blue_transition__S04__a__S04__mediante_met_transferOwnership for 10 EstadoConcreto, 5 Deposit, 10 SumatoriaSeq

pred blue_transition__S01__a__S01__mediante_met_deposit {
	some x: EstadoConcreto | partitionS01[x] and (not pre_deposit[x] or (all sender:{this/Address}, investor:{this/Address}, value:{Int} | pre_params_deposit[x,sender, investor, value] implies some y:EstadoConcreto | met_deposit[x,y,sender, investor, value] and not partitionS01[y]))
}
run blue_transition__S01__a__S01__mediante_met_deposit for 10 EstadoConcreto, 5 Deposit, 10 SumatoriaSeq

pred blue_transition__S01__a__S03__mediante_met_setGoalReached {
	some x: EstadoConcreto | partitionS01[x] and (not pre_setGoalReached[x] or (all sender:{this/Address}, value:{Int} | pre_params_setGoalReached[x,sender, value] implies some y:EstadoConcreto | met_setGoalReached[x,y,sender, value] and not partitionS03[y]))
}
run blue_transition__S01__a__S03__mediante_met_setGoalReached for 10 EstadoConcreto, 5 Deposit, 10 SumatoriaSeq
...
run blue_transition__S03__a__S03__mediante_met_t for 10 EstadoConcreto, 5 Deposit, 10 SumatoriaSeq

pred blue_transition__S03__a__S03__mediante_met_deposit {
	some x: EstadoConcreto | partitionS03[x] and (not pre_deposit[x] or (all sender:{this/Address}, investor:{this/Address}, value:{Int} | pre_params_deposit[x,sender, investor, value] implies some y:EstadoConcreto | met_deposit[x,y,sender, investor, value] and not partitionS03[y]))
}
run blue_transition__S03__a__S03__mediante_met_deposit for 10 EstadoConcreto, 5 Deposit, 10 SumatoriaSeq
...
run blue_transition__S02__a__S02__mediante_met_t for 10 EstadoConcreto, 5 Deposit, 10 SumatoriaSeq

pred blue_transition__S01__a__S01__mediante_met_transferOwnership {
	some x: EstadoConcreto | partitionS01[x] and (not pre_transferOwnership[x] or (all sender:{this/Address}, recipient:{this/Address} | pre_params_transferOwnership[x,sender, recipient] implies some y:EstadoConcreto | met_transferOwnership[x,y,sender, recipient] and not partitionS01[y]))
}
run blue_transition__S01__a__S01__mediante_met_transferOwnership for 10 EstadoConcreto, 5 Deposit, 10 SumatoriaSeq

pred blue_transition__S01__a__S02__mediante_met_enableRefunds {
	some x: EstadoConcreto | partitionS01[x] and (not pre_enableRefunds[x] or (all sender:{this/Address} | pre_params_enableRefunds[x,sender] implies some y:EstadoConcreto | met_enableRefunds[x,y,sender] and not partitionS02[y]))
}
run blue_transition__S01__a__S02__mediante_met_enableRefunds for 10 EstadoConcreto, 5 Deposit, 10 SumatoriaSeq
