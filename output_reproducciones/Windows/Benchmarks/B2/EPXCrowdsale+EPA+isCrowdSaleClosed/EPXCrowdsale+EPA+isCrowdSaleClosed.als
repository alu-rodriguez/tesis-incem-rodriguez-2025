...
pred blue_transition__S108__a__S89__mediante_met_t {
	some x: EstadoConcreto | partitionS108[x] and (not pre_t[x] or (all sender:{this/Address} | pre_params_t[x,sender] implies some y:EstadoConcreto | met_t[x,y,sender] and not partitionS89[y]))
}
run blue_transition__S108__a__S89__mediante_met_t for 10 EstadoConcreto, 3 Deposit

pred blue_transition__S108__a__S108__mediante_met_t {
	some x: EstadoConcreto | partitionS108[x] and (not pre_t[x] or (all sender:{this/Address} | pre_params_t[x,sender] implies some y:EstadoConcreto | met_t[x,y,sender] and not partitionS108[y]))
}
run blue_transition__S108__a__S108__mediante_met_t for 10 EstadoConcreto, 3 Deposit

pred blue_transition__S89__a__S89__mediante_met_t {
	some x: EstadoConcreto | partitionS89[x] and (not pre_t[x] or (all sender:{this/Address} | pre_params_t[x,sender] implies some y:EstadoConcreto | met_t[x,y,sender] and not partitionS89[y]))
}
run blue_transition__S89__a__S89__mediante_met_t for 10 EstadoConcreto, 3 Deposit

pred blue_transition__S89__a__S108__mediante_met_t {
	some x: EstadoConcreto | partitionS89[x] and (not pre_t[x] or (all sender:{this/Address} | pre_params_t[x,sender] implies some y:EstadoConcreto | met_t[x,y,sender] and not partitionS108[y]))
}
run blue_transition__S89__a__S108__mediante_met_t for 10 EstadoConcreto, 3 Deposit

pred blue_transition__S89__a__S89__mediante_met_checkGoalReached {
	some x: EstadoConcreto | partitionS89[x] and (not pre_checkGoalReached[x] or (all sender:{this/Address} | pre_params_checkGoalReached[x,sender] implies some y:EstadoConcreto | met_checkGoalReached[x,y,sender] and not partitionS89[y]))
}
run blue_transition__S89__a__S89__mediante_met_checkGoalReached for 10 EstadoConcreto, 3 Deposit

pred blue_transition__S23__a__S23__mediante_met_checkGoalReached {
	some x: EstadoConcreto | partitionS23[x] and (not pre_checkGoalReached[x] or (all sender:{this/Address} | pre_params_checkGoalReached[x,sender] implies some y:EstadoConcreto | met_checkGoalReached[x,y,sender] and not partitionS23[y]))
}
run blue_transition__S23__a__S23__mediante_met_checkGoalReached for 10 EstadoConcreto, 3 Deposit

pred blue_transition__S44__a__S44__mediante_met_checkGoalReached {
	some x: EstadoConcreto | partitionS44[x] and (not pre_checkGoalReached[x] or (all sender:{this/Address} | pre_params_checkGoalReached[x,sender] implies some y:EstadoConcreto | met_checkGoalReached[x,y,sender] and not partitionS44[y]))
}
run blue_transition__S44__a__S44__mediante_met_checkGoalReached for 10 EstadoConcreto, 3 Deposit

pred blue_transition__S89__a__S89__mediante_met_buy {
	some x: EstadoConcreto | partitionS89[x] and (not pre_buy[x] or (all sender:{this/Address}, value:{Int} | pre_params_buy[x,sender, value] implies some y:EstadoConcreto | met_buy[x,y,sender, value] and not partitionS89[y]))
}
run blue_transition__S89__a__S89__mediante_met_buy for 10 EstadoConcreto, 3 Deposit

pred blue_transition__S89__a__S108__mediante_met_buy {
	some x: EstadoConcreto | partitionS89[x] and (not pre_buy[x] or (all sender:{this/Address}, value:{Int} | pre_params_buy[x,sender, value] implies some y:EstadoConcreto | met_buy[x,y,sender, value] and not partitionS108[y]))
}
run blue_transition__S89__a__S108__mediante_met_buy for 10 EstadoConcreto, 3 Deposit

pred blue_transition__S113__a__S113__mediante_met_t {
	some x: EstadoConcreto | partitionS113[x] and (not pre_t[x] or (all sender:{this/Address} | pre_params_t[x,sender] implies some y:EstadoConcreto | met_t[x,y,sender] and not partitionS113[y]))
}
run blue_transition__S113__a__S113__mediante_met_t for 10 EstadoConcreto, 3 Deposit

pred blue_transition__S44__a__S44__mediante_met_t {
	some x: EstadoConcreto | partitionS44[x] and (not pre_t[x] or (all sender:{this/Address} | pre_params_t[x,sender] implies some y:EstadoConcreto | met_t[x,y,sender] and not partitionS44[y]))
}
run blue_transition__S44__a__S44__mediante_met_t for 10 EstadoConcreto, 3 Deposit

pred blue_transition__S113__a__S89__mediante_met_setupCrowdsale {
	some x: EstadoConcreto | partitionS113[x] and (not pre_setupCrowdsale[x] or (all sender:{this/Address}, fundingStartBlock:{Int}, fundingEndBlock:{Int}, value:{Int} | pre_params_setupCrowdsale[x,sender, fundingStartBlock, fundingEndBlock, value] implies some y:EstadoConcreto | met_setupCrowdsale[x,y,sender, fundingStartBlock, fundingEndBlock, value] and not partitionS89[y]))
}
run blue_transition__S113__a__S89__mediante_met_setupCrowdsale for 10 EstadoConcreto, 3 Deposit

pred blue_transition__S113__a__S108__mediante_met_setupCrowdsale {
	some x: EstadoConcreto | partitionS113[x] and (not pre_setupCrowdsale[x] or (all sender:{this/Address}, fundingStartBlock:{Int}, fundingEndBlock:{Int}, value:{Int} | pre_params_setupCrowdsale[x,sender, fundingStartBlock, fundingEndBlock, value] implies some y:EstadoConcreto | met_setupCrowdsale[x,y,sender, fundingStartBlock, fundingEndBlock, value] and not partitionS108[y]))
}
run blue_transition__S113__a__S108__mediante_met_setupCrowdsale for 10 EstadoConcreto, 3 Deposit

pred blue_transition__S108__a__S23__mediante_met_checkGoalReached {
	some x: EstadoConcreto | partitionS108[x] and (not pre_checkGoalReached[x] or (all sender:{this/Address} | pre_params_checkGoalReached[x,sender] implies some y:EstadoConcreto | met_checkGoalReached[x,y,sender] and not partitionS23[y]))
}
run blue_transition__S108__a__S23__mediante_met_checkGoalReached for 10 EstadoConcreto, 3 Deposit

pred blue_transition__S108__a__S44__mediante_met_checkGoalReached {
	some x: EstadoConcreto | partitionS108[x] and (not pre_checkGoalReached[x] or (all sender:{this/Address} | pre_params_checkGoalReached[x,sender] implies some y:EstadoConcreto | met_checkGoalReached[x,y,sender] and not partitionS44[y]))
}
run blue_transition__S108__a__S44__mediante_met_checkGoalReached for 10 EstadoConcreto, 3 Deposit

pred blue_transition__S108__a__S108__mediante_met_checkGoalReached {
	some x: EstadoConcreto | partitionS108[x] and (not pre_checkGoalReached[x] or (all sender:{this/Address} | pre_params_checkGoalReached[x,sender] implies some y:EstadoConcreto | met_checkGoalReached[x,y,sender] and not partitionS108[y]))
}
run blue_transition__S108__a__S108__mediante_met_checkGoalReached for 10 EstadoConcreto, 3 Deposit

pred blue_transition__S00__a__S113__mediante_met_constructor {
	some x: EstadoConcreto | partitionS00[x] and ((all sender:{this/Address} | pre_params_constructor[x,sender] implies some y:EstadoConcreto | met_constructor[x,y,sender] and not partitionS113[y]))
}
run blue_transition__S00__a__S113__mediante_met_constructor for 10 EstadoConcreto, 3 Deposit

pred blue_transition__S23__a__S23__mediante_met_refund {
	some x: EstadoConcreto | partitionS23[x] and (not pre_refund[x] or (all sender:{this/Address} | pre_params_refund[x,sender] implies some y:EstadoConcreto | met_refund[x,y,sender] and not partitionS23[y]))
}
run blue_transition__S23__a__S23__mediante_met_refund for 10 EstadoConcreto, 3 Deposit

pred blue_transition__S23__a__S44__mediante_met_refund {
	some x: EstadoConcreto | partitionS23[x] and (not pre_refund[x] or (all sender:{this/Address} | pre_params_refund[x,sender] implies some y:EstadoConcreto | met_refund[x,y,sender] and not partitionS44[y]))
}
run blue_transition__S23__a__S44__mediante_met_refund for 10 EstadoConcreto, 3 Deposit

pred blue_transition__S23__a__S23__mediante_met_t {
	some x: EstadoConcreto | partitionS23[x] and (not pre_t[x] or (all sender:{this/Address} | pre_params_t[x,sender] implies some y:EstadoConcreto | met_t[x,y,sender] and not partitionS23[y]))
}
run blue_transition__S23__a__S23__mediante_met_t for 10 EstadoConcreto, 3 Deposit

pred blue_transition__S122__a__S122__mediante_met_t {
	some x: EstadoConcreto | partitionS122[x] and (not pre_t[x] or (all sender:{this/Address} | pre_params_t[x,sender] implies some y:EstadoConcreto | met_t[x,y,sender] and not partitionS122[y]))
}
run blue_transition__S122__a__S122__mediante_met_t for 10 EstadoConcreto, 3 Deposit
...
pred turquoise_transition__S89__a__S89_S108__mediante_met_t {
	some x: EstadoConcreto | partitionS89[x] and (not pre_t[x] or (all sender:{this/Address} | pre_params_t[x,sender] implies some y:EstadoConcreto | met_t[x,y,sender] and not partitionS89[y] and not partitionS108[y]))
}
run turquoise_transition__S89__a__S89_S108__mediante_met_t for 10 EstadoConcreto, 3 Deposit

pred turquoise_transition__S108__a__S23_S44_S108__mediante_met_checkGoalReached {
	some x: EstadoConcreto | partitionS108[x] and (not pre_checkGoalReached[x] or (all sender:{this/Address} | pre_params_checkGoalReached[x,sender] implies some y:EstadoConcreto | met_checkGoalReached[x,y,sender] and not partitionS23[y] and not partitionS44[y] and not partitionS108[y]))
}
run turquoise_transition__S108__a__S23_S44_S108__mediante_met_checkGoalReached for 10 EstadoConcreto, 3 Deposit

pred turquoise_transition__S23__a__S23_S44__mediante_met_refund {
	some x: EstadoConcreto | partitionS23[x] and (not pre_refund[x] or (all sender:{this/Address} | pre_params_refund[x,sender] implies some y:EstadoConcreto | met_refund[x,y,sender] and not partitionS23[y] and not partitionS44[y]))
}
run turquoise_transition__S23__a__S23_S44__mediante_met_refund for 10 EstadoConcreto, 3 Deposit

pred turquoise_transition__S108__a__S89_S108__mediante_met_t {
	some x: EstadoConcreto | partitionS108[x] and (not pre_t[x] or (all sender:{this/Address} | pre_params_t[x,sender] implies some y:EstadoConcreto | met_t[x,y,sender] and not partitionS89[y] and not partitionS108[y]))
}
run turquoise_transition__S108__a__S89_S108__mediante_met_t for 10 EstadoConcreto, 3 Deposit
