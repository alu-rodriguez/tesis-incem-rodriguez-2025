...
pred blue_transition__S19__a__S17__mediante_met_bid {
	some x: EstadoConcreto | partitionS19[x] and (not pre_bid[x] or (all sender:{this/Address}, value:{Int} | pre_params_bid[x,sender, value] implies some y:EstadoConcreto | met_bid[x,y,sender, value] and not partitionS17[y]))
}
run blue_transition__S19__a__S17__mediante_met_bid for 10 EstadoConcreto

pred blue_transition__S19__a__S19__mediante_met_bid {
	some x: EstadoConcreto | partitionS19[x] and (not pre_bid[x] or (all sender:{this/Address}, value:{Int} | pre_params_bid[x,sender, value] implies some y:EstadoConcreto | met_bid[x,y,sender, value] and not partitionS19[y]))
}
run blue_transition__S19__a__S19__mediante_met_bid for 10 EstadoConcreto
...
pred blue_transition__S17__a__S18__mediante_met_t {
	some x: EstadoConcreto | partitionS17[x] and (not pre_t[x] or (all sender:{this/Address} | pre_params_t[x,sender] implies some y:EstadoConcreto | met_t[x,y,sender] and not partitionS18[y]))
}
run blue_transition__S17__a__S18__mediante_met_t for 10 EstadoConcreto
...
pred blue_transition__S19__a__S09__mediante_met_auctionEnd {
	some x: EstadoConcreto | partitionS19[x] and (not pre_auctionEnd[x] or (all sender:{this/Address} | pre_params_auctionEnd[x,sender] implies some y:EstadoConcreto | met_auctionEnd[x,y,sender] and not partitionS09[y]))
}
run blue_transition__S19__a__S09__mediante_met_auctionEnd for 10 EstadoConcreto
...
pred blue_transition__S20__a__S17__mediante_met_t {
	some x: EstadoConcreto | partitionS20[x] and (not pre_t[x] or (all sender:{this/Address} | pre_params_t[x,sender] implies some y:EstadoConcreto | met_t[x,y,sender] and not partitionS17[y]))
}
run blue_transition__S20__a__S17__mediante_met_t for 10 EstadoConcreto
...
pred blue_transition__S00__a__S19__mediante_met_constructor {
	some x: EstadoConcreto | partitionS00[x] and ((all sender:{this/Address}, biddingTime:{Int} | pre_params_constructor[x,sender, biddingTime] implies some y:EstadoConcreto | met_constructor[x,y,sender, biddingTime] and not partitionS19[y]))
}
run blue_transition__S00__a__S19__mediante_met_constructor for 10 EstadoConcreto

pred blue_transition__S00__a__S22__mediante_met_constructor {
	some x: EstadoConcreto | partitionS00[x] and ((all sender:{this/Address}, biddingTime:{Int} | pre_params_constructor[x,sender, biddingTime] implies some y:EstadoConcreto | met_constructor[x,y,sender, biddingTime] and not partitionS22[y]))
}
...
pred blue_transition__S00__a__S25__mediante_met_constructor {
	some x: EstadoConcreto | partitionS00[x] and ((all sender:{this/Address}, biddingTime:{Int} | pre_params_constructor[x,sender, biddingTime] implies some y:EstadoConcreto | met_constructor[x,y,sender, biddingTime] and not partitionS25[y]))
}
run blue_transition__S00__a__S25__mediante_met_constructor for 10 EstadoConcreto

pred blue_transition__S17__a__S17__mediante_met_bid {
	some x: EstadoConcreto | partitionS17[x] and (not pre_bid[x] or (all sender:{this/Address}, value:{Int} | pre_params_bid[x,sender, value] implies some y:EstadoConcreto | met_bid[x,y,sender, value] and not partitionS17[y]))
}
run blue_transition__S17__a__S17__mediante_met_bid for 10 EstadoConcreto

pred blue_transition__S19__a__S22__mediante_met_t {
	some x: EstadoConcreto | partitionS19[x] and (not pre_t[x] or (all sender:{this/Address} | pre_params_t[x,sender] implies some y:EstadoConcreto | met_t[x,y,sender] and not partitionS22[y]))
}
run blue_transition__S19__a__S22__mediante_met_t for 10 EstadoConcreto

pred blue_transition__S17__a__S17__mediante_met_withdraw {
	some x: EstadoConcreto | partitionS17[x] and (not pre_withdraw[x] or (all sender:{this/Address} | pre_params_withdraw[x,sender] implies some y:EstadoConcreto | met_withdraw[x,y,sender] and not partitionS17[y]))
}
run blue_transition__S17__a__S17__mediante_met_withdraw for 10 EstadoConcreto

pred blue_transition__S17__a__S19__mediante_met_withdraw {
	some x: EstadoConcreto | partitionS17[x] and (not pre_withdraw[x] or (all sender:{this/Address} | pre_params_withdraw[x,sender] implies some y:EstadoConcreto | met_withdraw[x,y,sender] and not partitionS19[y]))
}
run blue_transition__S17__a__S19__mediante_met_withdraw for 10 EstadoConcreto
...
pred blue_transition__S25__a__S19__mediante_met_t {
	some x: EstadoConcreto | partitionS25[x] and (not pre_t[x] or (all sender:{this/Address} | pre_params_t[x,sender] implies some y:EstadoConcreto | met_t[x,y,sender] and not partitionS19[y]))
}
run blue_transition__S25__a__S19__mediante_met_t for 10 EstadoConcreto
...
pred blue_transition__S17__a__S04__mediante_met_auctionEnd {
	some x: EstadoConcreto | partitionS17[x] and (not pre_auctionEnd[x] or (all sender:{this/Address} | pre_params_auctionEnd[x,sender] implies some y:EstadoConcreto | met_auctionEnd[x,y,sender] and not partitionS04[y]))
}
run blue_transition__S17__a__S04__mediante_met_auctionEnd for 10 EstadoConcreto
...
pred turquoise_transition__S20__a__S17_S20__mediante_met_t {
	some x: EstadoConcreto | partitionS20[x] and (not pre_t[x] or (all sender:{this/Address} | pre_params_t[x,sender] implies some y:EstadoConcreto | met_t[x,y,sender] and not partitionS17[y] and not partitionS20[y]))
}
run turquoise_transition__S20__a__S17_S20__mediante_met_t for 10 EstadoConcreto

pred turquoise_transition__S25__a__S19_S25__mediante_met_t {
	some x: EstadoConcreto | partitionS25[x] and (not pre_t[x] or (all sender:{this/Address} | pre_params_t[x,sender] implies some y:EstadoConcreto | met_t[x,y,sender] and not partitionS19[y] and not partitionS25[y]))
}
run turquoise_transition__S25__a__S19_S25__mediante_met_t for 10 EstadoConcreto
...
pred turquoise_transition__S25__a__S20_S25__mediante_met_bid {
	some x: EstadoConcreto | partitionS25[x] and (not pre_bid[x] or (all sender:{this/Address}, value:{Int} | pre_params_bid[x,sender, value] implies some y:EstadoConcreto | met_bid[x,y,sender, value] and not partitionS20[y] and not partitionS25[y]))
}
run turquoise_transition__S25__a__S20_S25__mediante_met_bid for 10 EstadoConcreto

pred turquoise_transition__S17__a__S17_S19__mediante_met_withdraw {
	some x: EstadoConcreto | partitionS17[x] and (not pre_withdraw[x] or (all sender:{this/Address} | pre_params_withdraw[x,sender] implies some y:EstadoConcreto | met_withdraw[x,y,sender] and not partitionS17[y] and not partitionS19[y]))
}
run turquoise_transition__S17__a__S17_S19__mediante_met_withdraw for 10 EstadoConcreto
...
pred turquoise_transition__S19__a__S17_S19__mediante_met_bid {
	some x: EstadoConcreto | partitionS19[x] and (not pre_bid[x] or (all sender:{this/Address}, value:{Int} | pre_params_bid[x,sender, value] implies some y:EstadoConcreto | met_bid[x,y,sender, value] and not partitionS17[y] and not partitionS19[y]))
}
run turquoise_transition__S19__a__S17_S19__mediante_met_bid for 10 EstadoConcreto
