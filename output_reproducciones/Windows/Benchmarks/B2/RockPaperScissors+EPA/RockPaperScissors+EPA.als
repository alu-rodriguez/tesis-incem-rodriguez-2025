...
pred blue_transition__S04__a__S07__mediante_met_choicePlayer2 {
	some x: EstadoConcreto | partitionS04[x] and (not pre_choicePlayer2[x] or (all sender:{this/Address}, choice:{Int}, value:{Int} | pre_params_choicePlayer2[x,sender, choice, value] implies some y:EstadoConcreto | met_choicePlayer2[x,y,sender, choice, value] and not partitionS07[y]))
}
run blue_transition__S04__a__S07__mediante_met_choicePlayer2 for 10 EstadoConcreto

pred blue_transition__S07__a__S05__mediante_met_choicePlayer1 {
	some x: EstadoConcreto | partitionS07[x] and (not pre_choicePlayer1[x] or (all sender:{this/Address}, choice:{Int}, value:{Int} | pre_params_choicePlayer1[x,sender, choice, value] implies some y:EstadoConcreto | met_choicePlayer1[x,y,sender, choice, value] and not partitionS05[y]))
}
run blue_transition__S07__a__S05__mediante_met_choicePlayer1 for 10 EstadoConcreto

pred blue_transition__S00__a__S04__mediante_met_constructor {
	some x: EstadoConcreto | partitionS00[x] and ((all player1:{this/Address}, player2:{this/Address}, owner:{this/Address} | pre_params_constructor[x,player1, player2, owner] implies some y:EstadoConcreto | met_constructor[x,y,player1, player2, owner] and not partitionS04[y]))
}
run blue_transition__S00__a__S04__mediante_met_constructor for 10 EstadoConcreto

pred blue_transition__S06__a__S05__mediante_met_choicePlayer2 {
	some x: EstadoConcreto | partitionS06[x] and (not pre_choicePlayer2[x] or (all sender:{this/Address}, choice:{Int}, value:{Int} | pre_params_choicePlayer2[x,sender, choice, value] implies some y:EstadoConcreto | met_choicePlayer2[x,y,sender, choice, value] and not partitionS05[y]))
}
run blue_transition__S06__a__S05__mediante_met_choicePlayer2 for 10 EstadoConcreto
...
pred blue_transition__S04__a__S06__mediante_met_choicePlayer1 {
	some x: EstadoConcreto | partitionS04[x] and (not pre_choicePlayer1[x] or (all sender:{this/Address}, choice:{Int}, value:{Int} | pre_params_choicePlayer1[x,sender, choice, value] implies some y:EstadoConcreto | met_choicePlayer1[x,y,sender, choice, value] and not partitionS06[y]))
}
run blue_transition__S04__a__S06__mediante_met_choicePlayer1 for 10 EstadoConcreto
