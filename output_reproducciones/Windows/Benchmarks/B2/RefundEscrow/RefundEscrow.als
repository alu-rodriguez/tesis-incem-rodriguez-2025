...
pred blue_transition__S03__a__S03__mediante_met_beneficiaryWithdraw {
	some x: EstadoConcreto | partitionS03[x] and (not pre_beneficiaryWithdraw[x] or (all sender:{this/Address} | pre_params_beneficiaryWithdraw[x,sender] implies some y:EstadoConcreto | met_beneficiaryWithdraw[x,y,sender] and not partitionS03[y]))
}
run blue_transition__S03__a__S03__mediante_met_beneficiaryWithdraw for 10 EstadoConcreto, 5 Deposit, 10 SumatoriaSeq

pred blue_transition__S02__a__S02__mediante_met_withdraw {
	some x: EstadoConcreto | partitionS02[x] and (not pre_withdraw[x] or (all sender:{this/Address}, payee:{this/Address} | pre_params_withdraw[x,sender, payee] implies some y:EstadoConcreto | met_withdraw[x,y,sender, payee] and not partitionS02[y]))
}
run blue_transition__S02__a__S02__mediante_met_withdraw for 10 EstadoConcreto, 5 Deposit, 10 SumatoriaSeq

pred blue_transition__S01__a__S03__mediante_met_close {
	some x: EstadoConcreto | partitionS01[x] and (not pre_close[x] or (all sender:{this/Address}, refundee:{this/Address}, value:{Int} | pre_params_close[x,sender, refundee, value] implies some y:EstadoConcreto | met_close[x,y,sender, refundee, value] and not partitionS03[y]))
}
run blue_transition__S01__a__S03__mediante_met_close for 10 EstadoConcreto, 5 Deposit, 10 SumatoriaSeq

pred blue_transition__S03__a__S03__mediante_met_t {
	some x: EstadoConcreto | partitionS03[x] and (not pre_t[x] or (all sender:{this/Address}, timeElapsed:{Int} | pre_params_t[x,sender, timeElapsed] implies some y:EstadoConcreto | met_t[x,y,sender, timeElapsed] and not partitionS03[y]))
}
...
pred blue_transition__S01__a__S01__mediante_met_deposit {
	some x: EstadoConcreto | partitionS01[x] and (not pre_deposit[x] or (all sender:{this/Address}, refundee:{this/Address}, value:{Int} | pre_params_deposit[x,sender, refundee, value] implies some y:EstadoConcreto | met_deposit[x,y,sender, refundee, value] and not partitionS01[y]))
}
run blue_transition__S01__a__S01__mediante_met_deposit for 10 EstadoConcreto, 5 Deposit, 10 SumatoriaSeq

pred blue_transition__S00__a__S01__mediante_met_constructor {
	some x: EstadoConcreto | partitionS00[x] and ((all sender:{this/Address}, beneficiary:{this/Address} | pre_params_constructor[x,sender, beneficiary] implies some y:EstadoConcreto | met_constructor[x,y,sender, beneficiary] and not partitionS01[y]))
}
...
pred blue_transition__S01__a__S01__mediante_met_transferPrimary {
	some x: EstadoConcreto | partitionS01[x] and (not pre_transferPrimary[x] or (all sender:{this/Address}, recipient:{this/Address} | pre_params_transferPrimary[x,sender, recipient] implies some y:EstadoConcreto | met_transferPrimary[x,y,sender, recipient] and not partitionS01[y]))
}
run blue_transition__S01__a__S01__mediante_met_transferPrimary for 10 EstadoConcreto, 5 Deposit, 10 SumatoriaSeq

pred blue_transition__S01__a__S01__mediante_met_t {
	some x: EstadoConcreto | partitionS01[x] and (not pre_t[x] or (all sender:{this/Address}, timeElapsed:{Int} | pre_params_t[x,sender, timeElapsed] implies some y:EstadoConcreto | met_t[x,y,sender, timeElapsed] and not partitionS01[y]))
}
run blue_transition__S01__a__S01__mediante_met_t for 10 EstadoConcreto, 5 Deposit, 10 SumatoriaSeq

pred blue_transition__S02__a__S02__mediante_met_transferPrimary {
	some x: EstadoConcreto | partitionS02[x] and (not pre_transferPrimary[x] or (all sender:{this/Address}, recipient:{this/Address} | pre_params_transferPrimary[x,sender, recipient] implies some y:EstadoConcreto | met_transferPrimary[x,y,sender, recipient] and not partitionS02[y]))
}
run blue_transition__S02__a__S02__mediante_met_transferPrimary for 10 EstadoConcreto, 5 Deposit, 10 SumatoriaSeq

pred blue_transition__S02__a__S02__mediante_met_t {
	some x: EstadoConcreto | partitionS02[x] and (not pre_t[x] or (all sender:{this/Address}, timeElapsed:{Int} | pre_params_t[x,sender, timeElapsed] implies some y:EstadoConcreto | met_t[x,y,sender, timeElapsed] and not partitionS02[y]))
}
run blue_transition__S02__a__S02__mediante_met_t for 10 EstadoConcreto, 5 Deposit, 10 SumatoriaSeq

pred blue_transition__S03__a__S03__mediante_met_transferPrimary {
	some x: EstadoConcreto | partitionS03[x] and (not pre_transferPrimary[x] or (all sender:{this/Address}, recipient:{this/Address} | pre_params_transferPrimary[x,sender, recipient] implies some y:EstadoConcreto | met_transferPrimary[x,y,sender, recipient] and not partitionS03[y]))
}
run blue_transition__S03__a__S03__mediante_met_transferPrimary for 10 EstadoConcreto, 5 Deposit, 10 SumatoriaSeq
