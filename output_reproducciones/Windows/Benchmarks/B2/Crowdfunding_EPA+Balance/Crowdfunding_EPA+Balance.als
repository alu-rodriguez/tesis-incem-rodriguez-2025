...
run blue_transition__S18__a__S18__mediante_met_t for 10 EstadoConcreto, 4 Int, 5 Backer, 10 SumatoriaSeq
...
run blue_transition__S20__a__S20__mediante_met_t for 10 EstadoConcreto, 4 Int, 5 Backer, 10 SumatoriaSeq

pred blue_transition__S20__a__S27__mediante_met_t {
	some x: EstadoConcreto | partitionS20[x] and (not pre_t[x] or (all sender:{this/Address} | pre_params_t[x,sender] implies some y:EstadoConcreto | met_t[x,y,sender] and not partitionS27[y]))
}
run blue_transition__S20__a__S27__mediante_met_t for 10 EstadoConcreto, 4 Int, 5 Backer, 10 SumatoriaSeq

pred blue_transition__S17__a__S17__mediante_met_t {
	some x: EstadoConcreto | partitionS17[x] and (not pre_t[x] or (all sender:{this/Address} | pre_params_t[x,sender] implies some y:EstadoConcreto | met_t[x,y,sender] and not partitionS17[y]))
}
run blue_transition__S17__a__S17__mediante_met_t for 10 EstadoConcreto, 4 Int, 5 Backer, 10 SumatoriaSeq

pred blue_transition__S17__a__S17__mediante_met_claim {
	some x: EstadoConcreto | partitionS17[x] and (not pre_claim[x] or (all sender:{this/Address} | pre_params_claim[x,sender] implies some y:EstadoConcreto | met_claim[x,y,sender] and not partitionS17[y]))
}
run blue_transition__S17__a__S17__mediante_met_claim for 10 EstadoConcreto, 4 Int, 5 Backer, 10 SumatoriaSeq

pred blue_transition__S17__a__S59__mediante_met_claim {
	some x: EstadoConcreto | partitionS17[x] and (not pre_claim[x] or (all sender:{this/Address} | pre_params_claim[x,sender] implies some y:EstadoConcreto | met_claim[x,y,sender] and not partitionS59[y]))
}
run blue_transition__S17__a__S59__mediante_met_claim for 10 EstadoConcreto, 4 Int, 5 Backer, 10 SumatoriaSeq

pred blue_transition__S52__a__S52__mediante_met_t {
	some x: EstadoConcreto | partitionS52[x] and (not pre_t[x] or (all sender:{this/Address} | pre_params_t[x,sender] implies some y:EstadoConcreto | met_t[x,y,sender] and not partitionS52[y]))
}
run blue_transition__S52__a__S52__mediante_met_t for 10 EstadoConcreto, 4 Int, 5 Backer, 10 SumatoriaSeq

pred blue_transition__S52__a__S59__mediante_met_t {
	some x: EstadoConcreto | partitionS52[x] and (not pre_t[x] or (all sender:{this/Address} | pre_params_t[x,sender] implies some y:EstadoConcreto | met_t[x,y,sender] and not partitionS59[y]))
}
run blue_transition__S52__a__S59__mediante_met_t for 10 EstadoConcreto, 4 Int, 5 Backer, 10 SumatoriaSeq

pred blue_transition__S59__a__S50__mediante_met_t {
	some x: EstadoConcreto | partitionS59[x] and (not pre_t[x] or (all sender:{this/Address} | pre_params_t[x,sender] implies some y:EstadoConcreto | met_t[x,y,sender] and not partitionS50[y]))
}
run blue_transition__S59__a__S50__mediante_met_t for 10 EstadoConcreto, 4 Int, 5 Backer, 10 SumatoriaSeq

pred blue_transition__S59__a__S59__mediante_met_t {
	some x: EstadoConcreto | partitionS59[x] and (not pre_t[x] or (all sender:{this/Address} | pre_params_t[x,sender] implies some y:EstadoConcreto | met_t[x,y,sender] and not partitionS59[y]))
}
run blue_transition__S59__a__S59__mediante_met_t for 10 EstadoConcreto, 4 Int, 5 Backer, 10 SumatoriaSeq

pred blue_transition__S27__a__S17__mediante_met_t {
	some x: EstadoConcreto | partitionS27[x] and (not pre_t[x] or (all sender:{this/Address} | pre_params_t[x,sender] implies some y:EstadoConcreto | met_t[x,y,sender] and not partitionS17[y]))
}
run blue_transition__S27__a__S17__mediante_met_t for 10 EstadoConcreto, 4 Int, 5 Backer, 10 SumatoriaSeq

pred blue_transition__S27__a__S18__mediante_met_t {
	some x: EstadoConcreto | partitionS27[x] and (not pre_t[x] or (all sender:{this/Address} | pre_params_t[x,sender] implies some y:EstadoConcreto | met_t[x,y,sender] and not partitionS18[y]))
}
run blue_transition__S27__a__S18__mediante_met_t for 10 EstadoConcreto, 4 Int, 5 Backer, 10 SumatoriaSeq

pred blue_transition__S27__a__S27__mediante_met_t {
	some x: EstadoConcreto | partitionS27[x] and (not pre_t[x] or (all sender:{this/Address} | pre_params_t[x,sender] implies some y:EstadoConcreto | met_t[x,y,sender] and not partitionS27[y]))
}
run blue_transition__S27__a__S27__mediante_met_t for 10 EstadoConcreto, 4 Int, 5 Backer, 10 SumatoriaSeq

pred blue_transition__S00__a__S50__mediante_met_constructor {
	some x: EstadoConcreto | partitionS00[x] and ((all sender:{this/Address}, owner:{this/Address}, max_block:{Int}, goal:{Int} | pre_params_constructor[x,sender, owner, max_block, goal] implies some y:EstadoConcreto | met_constructor[x,y,sender, owner, max_block, goal] and not partitionS50[y]))
}
run blue_transition__S00__a__S50__mediante_met_constructor for 10 EstadoConcreto, 4 Int, 5 Backer, 10 SumatoriaSeq

pred blue_transition__S00__a__S52__mediante_met_constructor {
	some x: EstadoConcreto | partitionS00[x] and ((all sender:{this/Address}, owner:{this/Address}, max_block:{Int}, goal:{Int} | pre_params_constructor[x,sender, owner, max_block, goal] implies some y:EstadoConcreto | met_constructor[x,y,sender, owner, max_block, goal] and not partitionS52[y]))
}
run blue_transition__S00__a__S52__mediante_met_constructor for 10 EstadoConcreto, 4 Int, 5 Backer, 10 SumatoriaSeq

pred blue_transition__S00__a__S59__mediante_met_constructor {
	some x: EstadoConcreto | partitionS00[x] and ((all sender:{this/Address}, owner:{this/Address}, max_block:{Int}, goal:{Int} | pre_params_constructor[x,sender, owner, max_block, goal] implies some y:EstadoConcreto | met_constructor[x,y,sender, owner, max_block, goal] and not partitionS59[y]))
}
run blue_transition__S00__a__S59__mediante_met_constructor for 10 EstadoConcreto, 4 Int, 5 Backer, 10 SumatoriaSeq

pred blue_transition__S20__a__S20__mediante_met_donate {
	some x: EstadoConcreto | partitionS20[x] and (not pre_donate[x] or (all sender:{this/Address}, value:{Int} | pre_params_donate[x,sender, value] implies some y:EstadoConcreto | met_donate[x,y,sender, value] and not partitionS20[y]))
}
run blue_transition__S20__a__S20__mediante_met_donate for 10 EstadoConcreto, 4 Int, 5 Backer, 10 SumatoriaSeq

pred blue_transition__S52__a__S20__mediante_met_donate {
	some x: EstadoConcreto | partitionS52[x] and (not pre_donate[x] or (all sender:{this/Address}, value:{Int} | pre_params_donate[x,sender, value] implies some y:EstadoConcreto | met_donate[x,y,sender, value] and not partitionS20[y]))
}
run blue_transition__S52__a__S20__mediante_met_donate for 10 EstadoConcreto, 4 Int, 5 Backer, 10 SumatoriaSeq

pred blue_transition__S52__a__S52__mediante_met_donate {
	some x: EstadoConcreto | partitionS52[x] and (not pre_donate[x] or (all sender:{this/Address}, value:{Int} | pre_params_donate[x,sender, value] implies some y:EstadoConcreto | met_donate[x,y,sender, value] and not partitionS52[y]))
}
run blue_transition__S52__a__S52__mediante_met_donate for 10 EstadoConcreto, 4 Int, 5 Backer, 10 SumatoriaSeq

pred blue_transition__S18__a__S50__mediante_met_getFunds {
	some x: EstadoConcreto | partitionS18[x] and (not pre_getFunds[x] or (all sender:{this/Address} | pre_params_getFunds[x,sender] implies some y:EstadoConcreto | met_getFunds[x,y,sender] and not partitionS50[y]))
}
run blue_transition__S18__a__S50__mediante_met_getFunds for 10 EstadoConcreto, 4 Int, 5 Backer, 10 SumatoriaSeq

pred blue_transition__S18__a__S59__mediante_met_getFunds {
	some x: EstadoConcreto | partitionS18[x] and (not pre_getFunds[x] or (all sender:{this/Address} | pre_params_getFunds[x,sender] implies some y:EstadoConcreto | met_getFunds[x,y,sender] and not partitionS59[y]))
}
run blue_transition__S18__a__S59__mediante_met_getFunds for 10 EstadoConcreto, 4 Int, 5 Backer, 10 SumatoriaSeq

pred blue_transition__S50__a__S50__mediante_met_t {
	some x: EstadoConcreto | partitionS50[x] and (not pre_t[x] or (all sender:{this/Address} | pre_params_t[x,sender] implies some y:EstadoConcreto | met_t[x,y,sender] and not partitionS50[y]))
}
run blue_transition__S50__a__S50__mediante_met_t for 10 EstadoConcreto, 4 Int, 5 Backer, 10 SumatoriaSeq

pred blue_transition__S50__a__S50__mediante_met_getFunds {
	some x: EstadoConcreto | partitionS50[x] and (not pre_getFunds[x] or (all sender:{this/Address} | pre_params_getFunds[x,sender] implies some y:EstadoConcreto | met_getFunds[x,y,sender] and not partitionS50[y]))
}
run blue_transition__S50__a__S50__mediante_met_getFunds for 10 EstadoConcreto, 4 Int, 5 Backer, 10 SumatoriaSeq
...
pred turquoise_transition__S20__a__S20_S27__mediante_met_t {
	some x: EstadoConcreto | partitionS20[x] and (not pre_t[x] or (all sender:{this/Address} | pre_params_t[x,sender] implies some y:EstadoConcreto | met_t[x,y,sender] and not partitionS20[y] and not partitionS27[y]))
}
run turquoise_transition__S20__a__S20_S27__mediante_met_t for 10 EstadoConcreto, 4 Int, 5 Backer, 10 SumatoriaSeq

pred turquoise_transition__S52__a__S52_S59__mediante_met_t {
	some x: EstadoConcreto | partitionS52[x] and (not pre_t[x] or (all sender:{this/Address} | pre_params_t[x,sender] implies some y:EstadoConcreto | met_t[x,y,sender] and not partitionS52[y] and not partitionS59[y]))
}
run turquoise_transition__S52__a__S52_S59__mediante_met_t for 10 EstadoConcreto, 4 Int, 5 Backer, 10 SumatoriaSeq

pred turquoise_transition__S27__a__S17_S18_S27__mediante_met_t {
	some x: EstadoConcreto | partitionS27[x] and (not pre_t[x] or (all sender:{this/Address} | pre_params_t[x,sender] implies some y:EstadoConcreto | met_t[x,y,sender] and not partitionS17[y] and not partitionS18[y] and not partitionS27[y]))
}
run turquoise_transition__S27__a__S17_S18_S27__mediante_met_t for 10 EstadoConcreto, 4 Int, 5 Backer, 10 SumatoriaSeq

pred turquoise_transition__S59__a__S50_S59__mediante_met_t {
	some x: EstadoConcreto | partitionS59[x] and (not pre_t[x] or (all sender:{this/Address} | pre_params_t[x,sender] implies some y:EstadoConcreto | met_t[x,y,sender] and not partitionS50[y] and not partitionS59[y]))
}
run turquoise_transition__S59__a__S50_S59__mediante_met_t for 10 EstadoConcreto, 4 Int, 5 Backer, 10 SumatoriaSeq

pred turquoise_transition__S17__a__S17_S59__mediante_met_claim {
	some x: EstadoConcreto | partitionS17[x] and (not pre_claim[x] or (all sender:{this/Address} | pre_params_claim[x,sender] implies some y:EstadoConcreto | met_claim[x,y,sender] and not partitionS17[y] and not partitionS59[y]))
}
run turquoise_transition__S17__a__S17_S59__mediante_met_claim for 10 EstadoConcreto, 4 Int, 5 Backer, 10 SumatoriaSeq

pred turquoise_transition__S18__a__S50_S59__mediante_met_getFunds {
	some x: EstadoConcreto | partitionS18[x] and (not pre_getFunds[x] or (all sender:{this/Address} | pre_params_getFunds[x,sender] implies some y:EstadoConcreto | met_getFunds[x,y,sender] and not partitionS50[y] and not partitionS59[y]))
}
run turquoise_transition__S18__a__S50_S59__mediante_met_getFunds for 10 EstadoConcreto, 4 Int, 5 Backer, 10 SumatoriaSeq
