...
pred pre_donate[e: EstadoConcreto] {
	e._maxBlock >= e._blockNumber //FIX
	e._init = True
}
...
run blue_transition__S20__a__S17__mediante_met_t for 10 EstadoConcreto, 4 Int, 5 Backer, 10 SumatoriaSeq
...
run blue_transition__S20__a__S18__mediante_met_t for 10 EstadoConcreto, 4 Int, 5 Backer, 10 SumatoriaSeq
...
pred blue_transition__S52__a__S50__mediante_met_t {
	some x: EstadoConcreto | partitionS52[x] and (not pre_t[x] or (all sender:{this/Address} | pre_params_t[x,sender] implies some y:EstadoConcreto | met_t[x,y,sender] and not partitionS50[y]))
}
run blue_transition__S52__a__S50__mediante_met_t for 10 EstadoConcreto, 4 Int, 5 Backer, 10 SumatoriaSeq
...
pred turquoise_transition__S20__a__S17_S18_S20__mediante_met_t {
	some x: EstadoConcreto | partitionS20[x] and (not pre_t[x] or (all sender:{this/Address} | pre_params_t[x,sender] implies some y:EstadoConcreto | met_t[x,y,sender] and not partitionS17[y] and not partitionS18[y] and not partitionS20[y]))
}
run turquoise_transition__S20__a__S17_S18_S20__mediante_met_t for 10 EstadoConcreto, 4 Int, 5 Backer, 10 SumatoriaSeq

pred turquoise_transition__S52__a__S50_S52_S59__mediante_met_t {
	some x: EstadoConcreto | partitionS52[x] and (not pre_t[x] or (all sender:{this/Address} | pre_params_t[x,sender] implies some y:EstadoConcreto | met_t[x,y,sender] and not partitionS50[y] and not partitionS52[y] and not partitionS59[y]))
}
run turquoise_transition__S52__a__S50_S52_S59__mediante_met_t for 10 EstadoConcreto, 4 Int, 5 Backer, 10 SumatoriaSeq
