...
pred blue_transition__S49__a__S49__mediante_met_t {
	some x: EstadoConcreto | partitionS49[x] and (not pre_t[x] or (all sender:{this/Address} | pre_params_t[x,sender] implies some y:EstadoConcreto | met_t[x,y,sender] and not partitionS49[y]))
}
run blue_transition__S49__a__S49__mediante_met_t for 10 EstadoConcreto, 3 Deposit

pred blue_transition__S44__a__S23__mediante_met_checkGoalReached {
	some x: EstadoConcreto | partitionS44[x] and (not pre_checkGoalReached[x] or (all sender:{this/Address} | pre_params_checkGoalReached[x,sender] implies some y:EstadoConcreto | met_checkGoalReached[x,y,sender] and not partitionS23[y]))
}
run blue_transition__S44__a__S23__mediante_met_checkGoalReached for 10 EstadoConcreto, 3 Deposit
...
run blue_transition__S25__a__S25__mediante_met_t for 10 EstadoConcreto, 3 Deposit

pred blue_transition__S25__a__S44__mediante_met_t {
	some x: EstadoConcreto | partitionS25[x] and (not pre_t[x] or (all sender:{this/Address} | pre_params_t[x,sender] implies some y:EstadoConcreto | met_t[x,y,sender] and not partitionS44[y]))
}
run blue_transition__S25__a__S44__mediante_met_t for 10 EstadoConcreto, 3 Deposit

pred blue_transition__S58__a__S58__mediante_met_t {
	some x: EstadoConcreto | partitionS58[x] and (not pre_t[x] or (all sender:{this/Address} | pre_params_t[x,sender] implies some y:EstadoConcreto | met_t[x,y,sender] and not partitionS58[y]))
}
run blue_transition__S58__a__S58__mediante_met_t for 10 EstadoConcreto, 3 Deposit
...
pred blue_transition__S25__a__S25__mediante_met_buy {
	some x: EstadoConcreto | partitionS25[x] and (not pre_buy[x] or (all sender:{this/Address}, value:{Int} | pre_params_buy[x,sender, value] implies some y:EstadoConcreto | met_buy[x,y,sender, value] and not partitionS25[y]))
}
run blue_transition__S25__a__S25__mediante_met_buy for 10 EstadoConcreto, 3 Deposit

pred blue_transition__S25__a__S44__mediante_met_buy {
	some x: EstadoConcreto | partitionS25[x] and (not pre_buy[x] or (all sender:{this/Address}, value:{Int} | pre_params_buy[x,sender, value] implies some y:EstadoConcreto | met_buy[x,y,sender, value] and not partitionS44[y]))
}
run blue_transition__S25__a__S44__mediante_met_buy for 10 EstadoConcreto, 3 Deposit

pred blue_transition__S00__a__S49__mediante_met_constructor {
	some x: EstadoConcreto | partitionS00[x] and ((all sender:{this/Address} | pre_params_constructor[x,sender] implies some y:EstadoConcreto | met_constructor[x,y,sender] and not partitionS49[y]))
}
run blue_transition__S00__a__S49__mediante_met_constructor for 10 EstadoConcreto, 3 Deposit

pred blue_transition__S25__a__S25__mediante_met_checkGoalReached {
	some x: EstadoConcreto | partitionS25[x] and (not pre_checkGoalReached[x] or (all sender:{this/Address} | pre_params_checkGoalReached[x,sender] implies some y:EstadoConcreto | met_checkGoalReached[x,y,sender] and not partitionS25[y]))
}
run blue_transition__S25__a__S25__mediante_met_checkGoalReached for 10 EstadoConcreto, 3 Deposit

pred blue_transition__S44__a__S25__mediante_met_t {
	some x: EstadoConcreto | partitionS44[x] and (not pre_t[x] or (all sender:{this/Address} | pre_params_t[x,sender] implies some y:EstadoConcreto | met_t[x,y,sender] and not partitionS25[y]))
}
run blue_transition__S44__a__S25__mediante_met_t for 10 EstadoConcreto, 3 Deposit
...
pred blue_transition__S49__a__S25__mediante_met_setupCrowdsale {
	some x: EstadoConcreto | partitionS49[x] and (not pre_setupCrowdsale[x] or (all sender:{this/Address}, fundingStartBlock:{Int}, fundingEndBlock:{Int}, value:{Int} | pre_params_setupCrowdsale[x,sender, fundingStartBlock, fundingEndBlock, value] implies some y:EstadoConcreto | met_setupCrowdsale[x,y,sender, fundingStartBlock, fundingEndBlock, value] and not partitionS25[y]))
}
run blue_transition__S49__a__S25__mediante_met_setupCrowdsale for 10 EstadoConcreto, 3 Deposit

pred blue_transition__S49__a__S44__mediante_met_setupCrowdsale {
	some x: EstadoConcreto | partitionS49[x] and (not pre_setupCrowdsale[x] or (all sender:{this/Address}, fundingStartBlock:{Int}, fundingEndBlock:{Int}, value:{Int} | pre_params_setupCrowdsale[x,sender, fundingStartBlock, fundingEndBlock, value] implies some y:EstadoConcreto | met_setupCrowdsale[x,y,sender, fundingStartBlock, fundingEndBlock, value] and not partitionS44[y]))
}
run blue_transition__S49__a__S44__mediante_met_setupCrowdsale for 10 EstadoConcreto, 3 Deposit
...
pred turquoise_transition__S44__a__S23_S44__mediante_met_checkGoalReached {
	some x: EstadoConcreto | partitionS44[x] and (not pre_checkGoalReached[x] or (all sender:{this/Address} | pre_params_checkGoalReached[x,sender] implies some y:EstadoConcreto | met_checkGoalReached[x,y,sender] and not partitionS23[y] and not partitionS44[y]))
}
run turquoise_transition__S44__a__S23_S44__mediante_met_checkGoalReached for 10 EstadoConcreto, 3 Deposit
...
pred turquoise_transition__S44__a__S25_S44__mediante_met_t {
	some x: EstadoConcreto | partitionS44[x] and (not pre_t[x] or (all sender:{this/Address} | pre_params_t[x,sender] implies some y:EstadoConcreto | met_t[x,y,sender] and not partitionS25[y] and not partitionS44[y]))
}
run turquoise_transition__S44__a__S25_S44__mediante_met_t for 10 EstadoConcreto, 3 Deposit

pred turquoise_transition__S25__a__S25_S44__mediante_met_t {
	some x: EstadoConcreto | partitionS25[x] and (not pre_t[x] or (all sender:{this/Address} | pre_params_t[x,sender] implies some y:EstadoConcreto | met_t[x,y,sender] and not partitionS25[y] and not partitionS44[y]))
}
run turquoise_transition__S25__a__S25_S44__mediante_met_t for 10 EstadoConcreto, 3 Deposit
