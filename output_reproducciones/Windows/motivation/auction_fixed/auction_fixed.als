...
run blue_transition__S07__a__S07__mediante_met_t for 10 EstadoConcreto, 4 Int, 5 Bidders, 10 SumatoriaSeq
...
run blue_transition__S09__a__S09__mediante_met_bid for 10 EstadoConcreto, 4 Int, 5 Bidders, 10 SumatoriaSeq
...
run blue_transition__S02__a__S07__mediante_met_auctionEnd for 10 EstadoConcreto, 4 Int, 5 Bidders, 10 SumatoriaSeq
...
run blue_transition__S12__a__S12__mediante_met_t for 10 EstadoConcreto, 4 Int, 5 Bidders, 10 SumatoriaSeq

pred blue_transition__S00__a__S06__mediante_met_constructor {
	some x: EstadoConcreto | partitionS00[x] and ((all sender:{this/Address}, beneficiary:{this/Address}, auctionStart:{Int}, biddingTime:{Int}, ownerFee:{Int} | pre_params_constructor[x,sender, beneficiary, auctionStart, biddingTime, ownerFee] implies some y:EstadoConcreto | met_constructor[x,y,sender, beneficiary, auctionStart, biddingTime, ownerFee] and not partitionS06[y]))
}
run blue_transition__S00__a__S06__mediante_met_constructor for 10 EstadoConcreto, 4 Int, 5 Bidders, 10 SumatoriaSeq

pred blue_transition__S00__a__S09__mediante_met_constructor {
	some x: EstadoConcreto | partitionS00[x] and ((all sender:{this/Address}, beneficiary:{this/Address}, auctionStart:{Int}, biddingTime:{Int}, ownerFee:{Int} | pre_params_constructor[x,sender, beneficiary, auctionStart, biddingTime, ownerFee] implies some y:EstadoConcreto | met_constructor[x,y,sender, beneficiary, auctionStart, biddingTime, ownerFee] and not partitionS09[y]))
}
run blue_transition__S00__a__S09__mediante_met_constructor for 10 EstadoConcreto, 4 Int, 5 Bidders, 10 SumatoriaSeq

pred blue_transition__S09__a__S02__mediante_met_t {
	some x: EstadoConcreto | partitionS09[x] and (not pre_t[x] or (all sender:{this/Address} | pre_params_t[x,sender] implies some y:EstadoConcreto | met_t[x,y,sender] and not partitionS02[y]))
}
run blue_transition__S09__a__S02__mediante_met_t for 10 EstadoConcreto, 4 Int, 5 Bidders, 10 SumatoriaSeq
...
run blue_transition__S09__a__S06__mediante_met_t for 10 EstadoConcreto, 4 Int, 5 Bidders, 10 SumatoriaSeq
...
run blue_transition__S09__a__S09__mediante_met_t for 10 EstadoConcreto, 4 Int, 5 Bidders, 10 SumatoriaSeq
...
run blue_transition__S06__a__S12__mediante_met_auctionEnd for 10 EstadoConcreto, 4 Int, 5 Bidders, 10 SumatoriaSeq
...
run blue_transition__S07__a__S07__mediante_met_withdraw for 10 EstadoConcreto, 4 Int, 5 Bidders, 10 SumatoriaSeq
...
run blue_transition__S07__a__S12__mediante_met_withdraw for 10 EstadoConcreto, 4 Int, 5 Bidders, 10 SumatoriaSeq
...
run blue_transition__S02__a__S02__mediante_met_t for 10 EstadoConcreto, 4 Int, 5 Bidders, 10 SumatoriaSeq
...
run blue_transition__S06__a__S06__mediante_met_t for 10 EstadoConcreto, 4 Int, 5 Bidders, 10 SumatoriaSeq
...
run blue_transition__S02__a__S02__mediante_met_withdraw for 10 EstadoConcreto, 4 Int, 5 Bidders, 10 SumatoriaSeq
...
run blue_transition__S02__a__S06__mediante_met_withdraw for 10 EstadoConcreto, 4 Int, 5 Bidders, 10 SumatoriaSeq
...
run turquoise_transition__S02__a__S02_S06__mediante_met_withdraw for 10 EstadoConcreto, 4 Int, 5 Bidders, 10 SumatoriaSeq

pred turquoise_transition__S09__a__S02_S06_S09__mediante_met_t {
	some x: EstadoConcreto | partitionS09[x] and (not pre_t[x] or (all sender:{this/Address} | pre_params_t[x,sender] implies some y:EstadoConcreto | met_t[x,y,sender] and not partitionS02[y] and not partitionS06[y] and not partitionS09[y]))
}
run turquoise_transition__S09__a__S02_S06_S09__mediante_met_t for 10 EstadoConcreto, 4 Int, 5 Bidders, 10 SumatoriaSeq
...
run turquoise_transition__S07__a__S07_S12__mediante_met_withdraw for 10 EstadoConcreto, 4 Int, 5 Bidders, 10 SumatoriaSeq
