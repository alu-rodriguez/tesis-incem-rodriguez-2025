...
pred blue_transition__S04__a__S10__mediante_met_makeOffer {
	some x: EstadoConcreto | partitionS04[x] and (not pre_makeOffer[x] or (all sender:{this/Address}, appraiser:{this/Address}, offerPrice:{Int} | pre_params_makeOffer[x,sender, appraiser, offerPrice] implies some y:EstadoConcreto | met_makeOffer[x,y,sender, appraiser, offerPrice] and not partitionS10[y]))
}
run blue_transition__S04__a__S10__mediante_met_makeOffer for 8 EstadoConcreto, 8 Int, 5 Address

pred blue_transition__S04__a__S16__mediante_met_makeOffer {
	some x: EstadoConcreto | partitionS04[x] and (not pre_makeOffer[x] or (all sender:{this/Address}, appraiser:{this/Address}, offerPrice:{Int} | pre_params_makeOffer[x,sender, appraiser, offerPrice] implies some y:EstadoConcreto | met_makeOffer[x,y,sender, appraiser, offerPrice] and not partitionS16[y]))
}
run blue_transition__S04__a__S16__mediante_met_makeOffer for 8 EstadoConcreto, 8 Int, 5 Address

pred blue_transition__S10__a__S24__mediante_met_accept {
	some x: EstadoConcreto | partitionS10[x] and (not pre_accept[x] or (all sender:{this/Address} | pre_params_accept[x,sender] implies some y:EstadoConcreto | met_accept[x,y,sender] and not partitionS24[y]))
}
run blue_transition__S10__a__S24__mediante_met_accept for 8 EstadoConcreto, 8 Int, 5 Address

pred blue_transition__S00__a__S04__mediante_met_constructor {
	some x: EstadoConcreto | partitionS00[x] and ((all sender:{this/Address}, price:{Int} | pre_params_constructor[x,sender, price] implies some y:EstadoConcreto | met_constructor[x,y,sender, price] and not partitionS04[y]))
}
run blue_transition__S00__a__S04__mediante_met_constructor for 8 EstadoConcreto, 8 Int, 5 Address
