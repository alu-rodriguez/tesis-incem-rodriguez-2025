...
run blue_transition__S02__a__S01__mediante_met_reject for 10 EstadoConcreto
...
run blue_transition__S02__a__S03__mediante_met_acceptOffer for 10 EstadoConcreto

pred blue_transition__S01__a__S03__mediante_met_acceptOffer {
	some x: EstadoConcreto | partitionS01[x] and (not pre_acceptOffer[x] or (all sender:{this/Address} | pre_params_acceptOffer[x,sender] implies some y:EstadoConcreto | met_acceptOffer[x,y,sender] and not partitionS03[y]))
}
run blue_transition__S01__a__S03__mediante_met_acceptOffer for 10 EstadoConcreto
...
pred blue_transition__S01__a__S02__mediante_met_makeOffer {
	some x: EstadoConcreto | partitionS01[x] and (not pre_makeOffer[x] or (all sender:{this/Address}, offerPrice:{Int} | pre_params_makeOffer[x,sender, offerPrice] implies some y:EstadoConcreto | met_makeOffer[x,y,sender, offerPrice] and not partitionS02[y]))
}
run blue_transition__S01__a__S02__mediante_met_makeOffer for 10 EstadoConcreto
